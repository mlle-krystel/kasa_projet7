  ...
  return (
    <>
      ...
      <div className="container-about">
        <Collapse title="Fiabilité" isAbout><p className="about-text">
        ...
        <Collapse title="Respect" isAbout><p className="about-text">
        ...
        <Collapse title="Service" isAbout><p className="about-text">
          La qualité du service est au cœur de notre engagement chez Kasa. Nous veillons à ce que chaque interaction, que ce soit avec nos hôtes ou nos locataires, soit empreinte de respect et de bienveillance.
       </p> </Collapse>
        <Collapse title="Sécurité" isAbout><p className="about-text">
